...
/*
    ex2) 매개변수가 있는 함수
    매개변수(parameter) : 함수를 호출할 때 전달될 값을 함수 내에서 변수로써 사용
...
add(10, 2) // 10,2를 매개변수에 전달 => 10,2를 인자로 하여 호출
...
// 숫자 두개를 입력받아 두 숫자의 빼기 결과를 반환하는 함수를 rusult02 변수에 담아서 console 출력해보기
// 1. 숫자 두개 입력받기
// 2. 두 숫자 빼기
// 3. result02 변수에 담기
...
function foo(num) {
  // 짝수가 아닌 경우 return 되어 이후 코드 실행되지 않는다.
  if (num % 2 !== 0) return
  // 실행할코드
  console.log('짝수!')
}
...
var divideNum = getDivide(num03, 3)
