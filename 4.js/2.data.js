...
console.log(0.1 + 0.2) // 부동소수점 표현 때문에 생기는 오차. 정밀한 수학 계산에는 적합 X.
...
console.log(name)
var num04 = '1'
console.log(typeof num04 + 2) // 문자열과 숫자를 더하면 문자열끼리 더한다. => 오류가 발생 X.

/*
    논리형(boolean) : 참과 거짓으로 표현되는 자료형 => true(참), false(거짓)
        => 조건식과 함께 사용한다. => 비교 연산자의 결과값은 논리형 데이터가 반환된다.
*/

var isTrue = true
console.log(typeof isTrue)
var isBig = 10 < 100 // 비교 연산자를 통해 값을 비교 후 false 반환.
console.log(isBig)
...
/*
    객체(Object) : 여러개의 데이터를 구조화하여 저장 가능
    {} 안에 key(속성이름) : value(속성값)의 형태로 작성한다.
