...
// 박스 클릭 시 border 추가 및 제거 (3px, 검은색 실선)
...
/* 
    ...
    버블링
        ...
        - 이벤트 위임 : 상위 요소에 이벤트를 등록하여 하위 요소의 이벤트를 처리한다.
            이벤트 위임 하는 이유
    ...
    캡쳐링
        ...
        - addEventListener의 세번째 인자로 true를 전달하면 캡쳐링
*/
